...
gender.to_sql(name = "gender", con = engine, if_exists= "fail")
...
occupation.to_sql(name = "occupation", con = engine, if_exists = "fail")
...
person_cleaned.to_sql(name = "person", con = engine, if_exists= "fail")
...
sleep_disorder.to_sql(name = "sleep_disorder", con = engine, if_exists = "fail")
...
sleep.to_sql(name = "sleep", con = engine, if_exists = "fail")
...
activity_df.to_sql(name = "activity", con = engine, if_exists = "fail")
...
bmi_df.to_sql(name = "bmi", con = engine, if_exists = "fail")
...
health.to_sql(name = "health", con = engine, if_exists = "fail")
